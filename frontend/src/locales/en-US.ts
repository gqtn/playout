export default {
    ...
    config: {
        ...
        help: 'Help',
        generalHelp: 'Sometimes it can happen that a file is corrupt but still playable. This can produce a streaming error for all following files. The only solution in this case is to stop playout and start it again.',
        stopThreshold: 'The threshold stops playout if it is asynchronous in time above this value. A number below 3 can cause unexpected errors.',
        ...
        In production, don't serve HLS playlists with playout; use Nginx or another web server!`,
        outputParam: 'HLS segment and playlist paths are relative.',
        restartTile: 'Restart Playout',
        restartText: 'Restart playout to apply changes?',
        ...
        sharedStorage: 'playout runs inside a container, use the same storage root for all channels!',
        timezone: 'Timezone',
    },
    user: {
